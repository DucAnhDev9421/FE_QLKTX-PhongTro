            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative hidden sm:block">
                    ...
                    <input
                        ...
                        className="bg-slate-800 border border-slate-700 text-sm text-white rounded-full pl-10 pr-4 py-2 w-64 focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 transition-all placeholder:text-slate-500"
                    />
                </div>
            </div>
